@extends('master');
@section('content')
<div class="untree_co-hero overlay" style="background-image: url('{{asset('assets/images/hero-img-1-min.jpg')}}');">
    ...
    <div class="row justify-content-between">
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
        <figure class="img-wrap-2">
          <img src="{{asset('assets/images/teacher-min.jpg')}}" alt="Image" class="img-fluid">
...
<div class="untree_co-section bg-light">
  <div class="container">
    ...
    <div class="row">
      ...
      @foreach($coursesnew as $course)
      <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
        <div class="custom-media">
          <a href="#"><img src="{{asset('assets/image/' . $course->image)}}" alt="Image" class="img-fluid"></a>
          <div class="custom-media-body">
            ...
            <div class="border-top d-flex justify-content-between pt-3 mt-3 align-items-center">
              <div><span class="price">{{$course->price}}</span></div>
  ...
  <div class="untree_co-section pt-0 bg-img overlay" style="background-image: url('{{asset('assets/images/img-school-1-min.jpg')}}');">
    <div class="container">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
            ...
            <img src="{{asset('assets/images/img-school-4-min.jpg')}}" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-stretch">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <div class="media-h d-flex h-100">
            <figure>
              <img src="{{asset('assets/image/' . $new->image)}}" alt="Image">
            </figure>
            <div class="media-h-body">
              <h2 class="mb-3"><a href="#">{{ $new->title }}</a></h2>
              <div class="meta mb-2"><span class="icon-calendar mr-2"></span><span>{{$new->created_a}}</span> <span class="icon-person mr-2"></span>Admin</div>
              <p>{{ $new->description}}</p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="00">
          <div class="pricing">
            <!-- <div class="pricing-img mb-4"><img src="{{asset('assets/images/1x/asset-1.png')}}" alt="Image" class="img-fluid"></div> -->
        ...
        <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="pricing">
            <!-- <div class="pricing-img mb-4"><img src="{{asset('assets/images/1x/asset-2.png')}}" alt="Image" class="img-fluid"></div> -->
            <div class="pricing-body">
        ...
        <div class="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="300">
          <div class="pricing">
            <!-- <div class="pricing-img mb-4"><img src="{{asset('assets/images/1x/asset-3.png')}}" alt="Image" class="img-fluid"></div> -->
            <div class="pricing-body">
          ...
          <div class="owl-carousel wide-slider-testimonial">
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{asset('assets/images/person_1.jpg')}}" alt="Free template by TemplateUX">
                  <h3>John Doe</h3>
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{asset('assets/images/person_2.jpg')}}" alt="Free template by TemplateUX">
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{asset('assets/images/person_3.jpg')}}" alt="Free template by TemplateUX">
                  <h3>Rob Smith</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="0">
          <img src="{{asset('assets/images/img-school-5-min.jpg')}}" alt="image" class="img-fluid rounded" style="max-height: 480px; width: 100%; object-fit: cover;">
        </div>
                ...
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{asset('assets/images/img-school-1-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{asset('assets/images/img-school-2-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                      <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{asset('assets/images/img-school-3-min.jpg')}}" alt="Image" class="img-fluid">
                    </div>
                    <div>
